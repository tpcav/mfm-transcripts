...
def generate_transcript(video_id):
    try:
        # Defining get_transcript() from API
        transcript = YouTubeTranscriptApi.get_transcript(video_id)
        script = ""

        # Format the data to remove the timestamps
    ...
    # Error handle for any ids that do not have transcripts
    except:
...
# Write the list to the JSON file ./outputs directory
